...
/* When a client connects we add them to SignalR group with the activityId.
 * And when a new comment is added then for that particular activity
 * we send the comment to all connected clients in that group.
 */
